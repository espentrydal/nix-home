...
let
  ...
  # font and bar height
  font_regular = lib.mkMerge [
    (lib.mkIf (osConfig.networking.hostName == "thinkpad-nixos")
     "Source Sans 3:style=Regular:size=14;3" )
    (lib.mkIf (osConfig.networking.hostName == "mainframe-nixos")
      "Source Sans 3:style=Regular:size=17;3" )
  ];
  font_bold = lib.mkMerge [
    (lib.mkIf (osConfig.networking.hostName == "thinkpad-nixos")
     "Source Sans 3:style=Bold:size=14;3" )
    (lib.mkIf (osConfig.networking.hostName == "mainframe-nixos")
      "Source Sans 3:style=Bold:size=17;3" )
  ];
  bar_height = lib.mkMerge [
    (lib.mkIf (osConfig.networking.hostName == "thinkpad-nixos")
      22 )
    (lib.mkIf (osConfig.networking.hostName == "mainframe-nixos")
      29 )
